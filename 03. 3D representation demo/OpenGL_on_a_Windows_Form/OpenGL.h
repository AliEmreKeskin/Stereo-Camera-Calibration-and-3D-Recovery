	...
	public:
		...
		System::Void Render(System::Void)
		{
			...
			for (int i = 0; i < line_count; i++) {
				...
				x1 = vertex[index[i * 2 + 0] * 3 + 0];
				y1 = vertex[index[i * 2 + 0] * 3 + 1];
				z1 = vertex[index[i * 2 + 0] * 3 + 2];
				x2 = vertex[index[i * 2 + 1] * 3 + 0];
				y2 = vertex[index[i * 2 + 1] * 3 + 1];
				z2 = vertex[index[i * 2 + 1] * 3 + 2];
				glVertex3f(x1, y1, z1);
				glVertex3f(x2, y2, z2);
			}
			glEnd();

...
float * LoadPoints(const char * filePath, int size)
{
	std::ifstream inData;
	inData.open(filePath);
...
private: System::Void button9_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	const char* pointsPath = "points.txt";
	point_count = 25;
	vertex = LoadPoints(pointsPath, point_count);
	line_count = 28;
	index = new int[line_count * 2]{
		0,1,
		0,2,
		0,3,
		4,5,
